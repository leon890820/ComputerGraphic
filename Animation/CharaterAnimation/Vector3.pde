static final public class Vector3 {
  ...
  void setUnitX() { x = 1.0f; y = 0.0f; z = 0.0f; }
  void setUnitY() { x = 0.0f; y = 1.0f; z = 0.0f; }
  void setUnitZ() { x = 0.0f; y = 0.0f; z = 1.0f; }
...
public class VectorX{
    float[] v;
    int s;
    public VectorX(int s){
        this.s = s;
        v = new float[s];
        setZero();
    }
    
    public VectorX(float[] f){
        s = f.length;
        v = f;
    }
    ...
    public VectorX add(VectorX a){
        if(s != a.s) return null;
        VectorX result = new VectorX(s);
        for(int i = 0; i < s; i++){
