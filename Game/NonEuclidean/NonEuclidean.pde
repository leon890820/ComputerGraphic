...
static Vector3 AMBIENT_LIGHT=new Vector3(0.8,0.8,0.8);
...
void setup(){
  size(640,640);
  background(0);
  light=new Light(new Vector3(0,0,5),new Vector3(0,0,-1),new Vector3(1,1,1));
...
void draw(){
  ...
  //ry+=map(mouseY-pmouseY,0,10,0,0.1);
   ...
   //main_cam.setPositionOrientation(new Vector3(px,5,py),ry,rx);
