...
public class JumpFloodMaterial extends Material {

    Texture JFAOriginal;


    public JumpFloodMaterial(String frag) {
        super(frag);
    }
    public JumpFloodMaterial(String frag, String vert) {
        super(frag, vert);
    }

    public JumpFloodMaterial setTexture(Texture t) {
        JFAOriginal = t;
        return this;
    }
    ...
    public void run(GameObject go) {
        setGameobject(go); 
        shader.set("JFAOriginal", JFAOriginal.img);
    }
}

public class JumpFloodPassMaterial extends Material {
    ...
    public JumpFloodPassMaterial(String frag) {
        super(frag);
    }
    public JumpFloodPassMaterial(String frag, String vert) {
        super(frag, vert);
    }

    public JumpFloodPassMaterial setTexture(Texture t) {
        JFATexture = t;
        return this;
    }
    
    public JumpFloodPassMaterial setTexture2(Texture t) {
        JFATexture2 = t;
        return this;
    }
    
    public JumpFloodPassMaterial setStep(float f) {
        step = f;
        return this;
    }
    
    public JumpFloodPassMaterial setFirst(boolean b) {
        first = b;
        return this;
    }
    ...
    public void run(GameObject go) {
        setGameobject(go); 
        shader.set("JFATexture", JFATexture.img);
        setTexture("JFATexture2", JFATexture2 , 1);
        shader.set("step", step);
        shader.set("first", first);
    }
}
