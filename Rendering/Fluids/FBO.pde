...
public class SSBO{
    ...
    IntBuffer ssbo;
    int base;
    public SSBO(int base , Material mat, float[] data){
        material = mat;
    ...
    void updateData(float[] data){
        ...
        gl3.glBindBufferBase(gl3.GL_SHADER_STORAGE_BUFFER, base, ssbo.get(0));
        gl3.glBufferData(gl3.GL_SHADER_STORAGE_BUFFER,Float.BYTES * data.length, floatBuffer,gl3.GL_DYNAMIC_DRAW);
