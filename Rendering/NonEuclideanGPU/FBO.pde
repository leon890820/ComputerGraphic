public class FBO {
    ...
    public FBO(int w,int h, int num){
        ...
        for(int i = 0; i < num ; i++){
            ...
            gl3.glTexImage2D(gl3.GL_TEXTURE_2D, 0, gl3.GL_RGBA, w, h, 0, gl3.GL_RGBA, gl3.GL_UNSIGNED_BYTE, null); 
            ...
            gl3.glFramebufferTexture2D(gl3.GL_FRAMEBUFFER, gl3.GL_COLOR_ATTACHMENT0 + i, gl3.GL_TEXTURE_2D, tex[i].tex.get(0), 0);
            color_attachment[i] = gl3.GL_COLOR_ATTACHMENT0 + i;
        }
