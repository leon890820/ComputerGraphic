...
public class Quad extends GameObject{
    ...
    public void initMesh(){
        mesh.verts.add(new Vector3(-1,-1, 0));
        mesh.verts.add(new Vector3( 1,-1, 0));
        mesh.verts.add(new Vector3( 1, 1, 0));
        mesh.verts.add(new Vector3(-1, 1, 0));
        ...
        mesh.uvs.add(new Vector3(1, 1, 0));
        mesh.uvs.add(new Vector3(0, 1, 0));
        
        mesh.addFace(0,0,0,1,1,1,2,2,2);
        mesh.addFace(0,0,0,2,2,2,3,3,3);
    }
