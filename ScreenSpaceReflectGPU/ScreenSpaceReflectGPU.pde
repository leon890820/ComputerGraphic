...
static float GH_WALK_SPEED = 0.10f;
...
void draw() {
    ...
    main_light.setPosition( -200 * cos(a), 200 , -200 * sin(a) );    
...
public void cameraSetting() {
    ...
    main_camera.setPosition(0.0, 3.0, 3.0).setEular(-0.0, 0.0, 0.0);
    main_camera.setSize((float)width, (float)height, GH_NEAR_MAX, GH_FAR);
}

public void lightSetting() {
    main_light = new Light(new Vector3(-200 * cos(a), 200 , -200 * sin(a) ), new Vector3(200 * cos(a), -200 ,200 * sin(a)), new Vector3(0.8));
